...
% 
% USAGE
% [adaptedDietConstraints,growthOK] = adaptVMHDietToAGORA(VMHDietConstraints,setupUsed,AGORAPath)
...
% load the text file with the diet
VMHDietConstraints = readtable(strcat(VMHDiet,'.txt'),'Delimiter','\t');
