...
function model2text(data)

% NOTE: script was inteded to take both completed reconstruction models and
% table of reactions from reconstruction creator. For now it only takes
% models. 
%
model = true;
if model
