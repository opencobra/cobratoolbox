...
% This script is complex and badly written, I will have to remove (or rewrite) it soon.
% 18. DEC 2011 SGT
...
%   metab - metabolite database
%   meta_compartemnt - compartment database
%   newrxns - new reactions to be added (rBioNet format)
%   data - perhaps similarity data, I really don't know, use empty []
% 
% OUTPUT:
%   data_output - {newrxns,data,check}
%   newrxns - newlist of new reactions
%   data - similarity reactions
%   check - 1 if checks are finished. 
% 
...
data_output = {newrxns,data,model};
