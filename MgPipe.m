...
[reac,MicRea,BinOrg,patOrg,ReacPat,reacNumb,ReacSet,ReacTab,ReacAbun,patNumb,reacnumber]=getMappingInfo(models,infoPath,'normCoverage.csv',patnumb)
writetable(cell2table(ReacAbun),strcat(resPath,'reactions.csv'))
 
[PCoA]=plotMappingInfo(patOrg,ReacPat,ReacTab,patNumb,reacnumber,patstat) 
...
[Y]=plotMappingInfo(patOrg,ReacPat,ReacTab,patNumb,reacnumber,patstat)
