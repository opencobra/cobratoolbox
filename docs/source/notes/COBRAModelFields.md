...
|`model.metSBOTerm`| `m x 1` | Column Cell Array of Strings | The SBO Identifier associated with the metabolite | 
...
|`model.rxnSBOTerm`| `n x 1` | Column Cell Array of Strings | The SBO Identifier associated with the reaction | 
