    ...
    <div class="wrapper">
        <ul class="metro">
            <li class="small-tile-text color_class5 scale-10">
                <a class="tile" style="width: 90px; height: 90px;" href="https://gibbs.unal.edu.co/cobradoc/cobratoolbox/tutorials/base/primer/practical_COBRA_primer.pdf">
...
.. raw:: html
    ...
    <div style="margin:-30px; margin-right:-30px;">
      <iframe src="https://gibbs.unal.edu.co/cobradoc/cobratoolbox/tutorials/base/primer/iframe_practical_COBRA_primer.html" width="100%" scrolling="yes" id="iFrameResizer0" style="overflow: visible; height: 228px;" frameborder="0"></iframe>
    </div>
