function [modelOut,nTotalAtomTransitions,nTotalBondTransitions ] = checkABRXNFiles(model, RXNFileDir)
...
for i = 1:nRxns
    if RXNBool(i)
        ...
        if checkDecompartmentaliseRXN==1
            ...
            metNrs=atoms.metNrs;
            atomTransitionNrs=atoms.atomTransitionNrs;
        ...
        if ~all(atomTransitionNrs==0)
            ...
            %Bonds
            nBondTransitions = max(bondTransitionNrs);
            ...
            %calculate the total number of bond transitions
            nTotalBondTransitions  = nTotalBondTransitions + nBondTransitions;
        end
    end
end
