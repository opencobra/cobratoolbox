...
%    IndividualParameters:    structure of physiological parameters, as generated by
%                            standardPhysiolDefaultParameters, with fields:
%
...
%    Type:                   input type, either 'xlsx' (default, loads
%                            'Parsed_hmdbConc.xlsx') or 'direct' (InputData must be provided)
%    InputData:              data whose first column holds VMH IDs of metabolites and
%                            second column the data points (set as lb and ub)
%    Biofluid:               'all' (default when Type is 'xlsx'); for 'direct' one of
%                            'bc', 'u', 'csf'
%    setDefault:             if the input data lacks a concentration for a metabolite, a
%                            default concentration range is used to compute the constraints
%                            (default: 1); ranges come from IndividualParameters
%    ExclMet:                whether certain metabolites (and their reactions) are excluded
%                            from the constraint application (default: 0)
