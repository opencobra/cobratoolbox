...
% Translates organism identifiers in a published metagenomic or 16S 
% rRNA data file with organism abundances (retrieved e.g., from  MetaPhlAn)
% to AGORA pan-model IDs. This will not catch every case since the format
% of input files with abundance data greatly varies. Feel free to modify
% this function and submit a pull request to enable more input files to be
...
%                             16S rRNA or metagenomic samples.
%
% OPTIONAL INPUT:
