...
%                       previous point sets:
%
%                         * .A - LHS matrix (optionally, if not set the script checks for `.S`)
%                         * .S - stoichiometric matrix used as `.A` when `.A` is absent
%                         * .b - RHS vector
%                         * .csense - Constraint type for each row in `A` ('G', 'L', 'E')
%                         * .lb - Lower bound
%                         * .ub - Upper bound
%                         * .warmupPts - Set of warmup points (optional, generated by default)
%                         * .points - Currently sampled points (optional)
%                         * .internal - internal preprocessing data generated by the sampler
...
%    mixedFrac:          The fraction mixed (relative to the `warmupPts`).  A value of 1
