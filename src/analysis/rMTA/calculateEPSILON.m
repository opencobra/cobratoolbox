function epsilon = calculateEPSILON(samples, rxnFBS, unique_epsilon, minimum)
...
% USAGE:
%
%    epsilon = calculateEPSILON(samples, rxnFBS, type, minimum)
%
% INPUT:
...
if unique_epsilon
    ...
    epsilon(epsilon<minimum) = minimum;
    epsilon(rxnFBS==0) = 0;
end
