...
% Compute personalised physiological parameters and constraints for a
% whole-body metabolic model from provided individual laboratory input data
%
% USAGE:
%
...
%    IndividualParameters:     structure of individual physiological parameters
%                            (for example generated by
%                            standardPhysiolDefaultParameters), read and updated
%                            with the fields:
%
...
%    InputData:              cell array with one row per measurement and columns
%                            {parameter/metabolite name, unit, value}; the
%                            metabolite compartment is indicated by a `[bc]`,
%                            `[u]` or `[csf]` suffix on the name
%
% OPTIONAL INPUT:
...
%
% OUTPUTS:
%    modelPersonalized:        whole-body metabolic model with personalised
%                              physiological and metabolomic constraints applied
%                              (its `.osenseStr` is set to 'max')
%    IndividualParametersNew:    updated individual parameters, i.e. the input
%                              IndividualParameters after personalisation
%
% .. Author: - Ines Thiele, 2016-2018
