...
for j = a : z
    if 1
        ...
        if set ==0
        S= load(strcat('Y:\Federico\HMP\Run_Almut_17_03_31_with10_new_strains\Results_Setup2\microbiota_model_samp_',files{j}));
        else
              S= load(strcat('/home/ines.thiele/atlas_lcsb_spg/Federico/HMP/Run_Almut_17_03_31_with10_new_strains/Results_Setup2/microbiota_model_samp_',files{j},'.mat'));    
        end
    ...
    if 0
        ...
        if strcmp(gender,'male')
            ...
            save(strcat('Results_male_microbiota_model_samp1_',files{j},'.mat'), 'modelHM', 'microbiota_model' ,'modelOrganAllCoupled' ,'Results');
            save ResultsAll_male1 ResultsAll USecretion  BSecretion % KSecretion
        else
            ...
            save(strcat('Results_female_microbiota_model_samp1_',files{j},'.mat'), 'modelHM', 'microbiota_model' ,'modelOrganAllCoupled' ,'Results');
            save ResultsAll_female1 ResultsAll USecretion BSecretion % KSecretion
        end
    else
        if strcmp(gender,'male')
            Results.gender = 'male';
            ...
            % save Results_male_microbiota_model_samp_SRS064645.mat modelHM microbiota_model modelOrganAllCoupled Results
            % save Results_male_microbiota_model_samp_SRS011084.mat modelHM microbiota_model modelOrganAllCoupled Results
            save(strcat('2017_12_12_HMP_male_microbiota_model_samp1_',files{j},'.mat'), 'modelHM', 'microbiota_model' ,'modelOrganAllCoupled' );
        else
            Results.gender = 'female';
            Results.ID = files{j};
            modelOrganAllCoupled = female;
            %   save Results_female_microbiota_model_samp_SRS024388.mat modelHM microbiota_model modelOrganAllCoupled Results
            save(strcat('2017_12_12_HMP_female_microbiota_model_samp1   _',files{j},'.mat'), 'modelHM', 'microbiota_model' ,'modelOrganAllCoupled' );
        end
    end
end