...
%
% Calculates the basal metabolic rate using the phenomenological model
% proposed by Harris-Benedict and derivations thereof (see references). See
% also the corresponding Wikipedia entry:
...
%
%                 1. the original Harris-Benedict equations [1], [2]
%                 2. the Harris-Benedict equations revised by Roza and Shizgal in 1984 [3]
