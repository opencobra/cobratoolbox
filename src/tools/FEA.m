...
if nargin<3
    fprintf('the function is called with model, reaction set and group as arguments')
end
if ~isvector(rxnSet)
    fprintf('Please provide the indices of the reactions e.g. 1:10')
end
if ~ischar(group)
    fprintf('Please provide the group name as string of characters e.g. ''subSystems'' ')
end
...
nRxns = occ;% the number of reactions per susbsystem
