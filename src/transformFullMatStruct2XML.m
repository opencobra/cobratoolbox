function [] = transformFullMatStruct2XML(xmlObject, map, fileName)
...
% USAGE:
%
%   [] = transformFullMatStruct2XML(xmlObject, map, fileName)
%
% INPUTS:
...
% .. Author: - N.Sompairac - Institut Curie, Paris, 24/07/2017
    ...
    if ~isempty(map.cplxAlias)
        ...
        % conversion
        for cplx = 1:length(map.cplxAlias)
            ...
            if ~isempty(map.cplxCompartAlias{cplx})
                xmlObject.sbml.model.annotation.celldesigner_colon_extension.celldesigner_colon_listOfComplexSpeciesAliases.celldesigner_colon_complexSpeciesAlias{cplx}.Attributes.compartmentAlias = map.cplxCompartAlias{cplx};
            end
            xmlObject.sbml.model.annotation.celldesigner_colon_extension.celldesigner_colon_listOfComplexSpeciesAliases.celldesigner_colon_complexSpeciesAlias{cplx}.celldesigner_colon_bounds.Attributes.x = map.cplxXPos{cplx};
            xmlObject.sbml.model.annotation.celldesigner_colon_extension.celldesigner_colon_listOfComplexSpeciesAliases.celldesigner_colon_complexSpeciesAlias{cplx}.celldesigner_colon_bounds.Attributes.y = map.cplxYPos{cplx};
            xmlObject.sbml.model.annotation.celldesigner_colon_extension.celldesigner_colon_listOfComplexSpeciesAliases.celldesigner_colon_complexSpeciesAlias{cplx}.celldesigner_colon_bounds.Attributes.w = map.cplxWidth{cplx};
            xmlObject.sbml.model.annotation.celldesigner_colon_extension.celldesigner_colon_listOfComplexSpeciesAliases.celldesigner_colon_complexSpeciesAlias{cplx}.celldesigner_colon_bounds.Attributes.h = map.cplxHeight{cplx};
            xmlObject.sbml.model.annotation.celldesigner_colon_extension.celldesigner_colon_listOfComplexSpeciesAliases.celldesigner_colon_complexSpeciesAlias{cplx}.celldesigner_colon_usualView.celldesigner_colon_paint.Attributes.color = map.cplxColor{cplx};
        end
    end
    ...
    if ~isempty(map.specIncID)
        ...
        for included = 1:length(map.specIncID)
            xmlObject.sbml.model.annotation.celldesigner_colon_extension.celldesigner_colon_listOfIncludedSpecies.celldesigner_colon_species{included}.Attributes.id = map.specIncID{included};
            xmlObject.sbml.model.annotation.celldesigner_colon_extension.celldesigner_colon_listOfIncludedSpecies.celldesigner_colon_species{included}.Attributes.name = map.specIncName{included};
            xmlObject.sbml.model.annotation.celldesigner_colon_extension.celldesigner_colon_listOfIncludedSpecies.celldesigner_colon_species{included}.celldesigner_colon_annotation.celldesigner_colon_complexSpecies.Text = map.specIncCplxID{included};
            xmlObject.sbml.model.annotation.celldesigner_colon_extension.celldesigner_colon_listOfIncludedSpecies.celldesigner_colon_species{included}.celldesigner_colon_annotation.celldesigner_colon_speciesIdentity.celldesigner_colon_class.Text = map.specIncType{included};
            % Test if there are notes for the included species
            if ~isempty(map.specIncNotes)
                xmlObject.sbml.model.annotation.celldesigner_colon_extension.celldesigner_colon_listOfIncludedSpecies.celldesigner_colon_species{included}.celldesigner_colon_notes.html.body.Text = map.specIncNotes{included};
            end
        end
    end
    ...
    for react = 1:length(map.rxnID)
        ...
        if ~isempty(map.rxnReactantAlias{react})
            ...
            if length(map.rxnReactantAlias{react}) == 1
                xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfReactantLinks.celldesigner_colon_reactantLink.Attributes.alias = map.rxnReactantAlias{react}{1};
                xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfReactantLinks.celldesigner_colon_reactantLink.Attributes.reactant = map.rxnReactantID{react}{1};
                xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfReactantLinks.celldesigner_colon_reactantLink.celldesigner_colon_line.Attributes.type = map.rxnReactantLineType{react}{1};
                xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfReactantLinks.celldesigner_colon_reactantLink.celldesigner_colon_line.Attributes.color = map.rxnReactantLineColor{react}{1};
                xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfReactantLinks.celldesigner_colon_reactantLink.celldesigner_colon_line.Attributes.width = map.rxnReactantLineWidth{react}{1};
            else
                for x = 1:length(map.rxnReactantAlias{react})
                    ...
                    xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfReactantLinks.celldesigner_colon_reactantLink{x}.celldesigner_colon_line.Attributes.type = map.rxnReactantLineType{react}{x};
                    xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfReactantLinks.celldesigner_colon_reactantLink{x}.celldesigner_colon_line.Attributes.color = map.rxnReactantLineColor{react}{x};
                    xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfReactantLinks.celldesigner_colon_reactantLink{x}.celldesigner_colon_line.Attributes.width = map.rxnReactantLineWidth{react}{x};
                end
                clearvars x
            end
        end
        ...
        if ~isempty(map.rxnProductAlias{react})
            ...
            if length(map.rxnProductAlias{react}) == 1
                xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfProductLinks.celldesigner_colon_productLink.Attributes.alias = map.rxnProductAlias{react}{1};
                xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfProductLinks.celldesigner_colon_productLink.Attributes.product = map.rxnProductID{react}{1};
                xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfProductLinks.celldesigner_colon_productLink.celldesigner_colon_line.Attributes.type = map.rxnProductLineType{react}{1};
                xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfProductLinks.celldesigner_colon_productLink.celldesigner_colon_line.Attributes.color = map.rxnProductLineColor{react}{1};
                xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfProductLinks.celldesigner_colon_productLink.celldesigner_colon_line.Attributes.width = map.rxnProductLineWidth{react}{1};
            else
                for x = 1:length(map.rxnProductAlias{react})
                    ...
                    xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfProductLinks.celldesigner_colon_productLink{x}.celldesigner_colon_line.Attributes.type = map.rxnProductLineType{react}{x};
                    xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfProductLinks.celldesigner_colon_productLink{x}.celldesigner_colon_line.Attributes.color = map.rxnProductLineColor{react}{x};
                    xmlObject.sbml.model.listOfReactions.reaction{react}.annotation.celldesigner_colon_extension.celldesigner_colon_listOfProductLinks.celldesigner_colon_productLink{x}.celldesigner_colon_line.Attributes.width = map.rxnProductLineWidth{react}{x};
                end
                clearvars x
            end
        end
