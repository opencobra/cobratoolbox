function [x_best, psi_best, out] = DBDF(mapp, x0, options)
% DBDF is a derivative-free algorithm for solving systems of nonlinear
% equations :math:`f(x) = 0`, x in :math:`R^m`
% using the nonlinear unconstrained minimization :math:`\textrm{min}\  \psi(x) = 1/2 ||f(x)||^2`
% s.t. `x` in :math:`R^m`.
%
% USAGE:
%
...
%
% .. REFERENCE:
% .. Algorithm 3 of [1]: F.J. Aragon Artacho, R.M.T. Fleming, Globally convergent algorithms for finding zeros of duplomonotone mappings, Optimization Letter, 9, 569-584 (2015)
