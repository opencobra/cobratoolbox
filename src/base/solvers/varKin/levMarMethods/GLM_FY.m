...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% LM_YF.m %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function[ x_best,psi_best,out ]=GLM_FY(mapp,lin_sym_solver,x0,options) 
...
% REFERENCE: 
%
% [1] J. Fan, Y. Yuan, On  the  quadratic  convergence  of  the  
%      Levenberg-Marquardt method without nonsingularity assumption,
%      Computing, 74(1), 23-39  (2005)
%
%           
% WRITTEN BY: 
%
