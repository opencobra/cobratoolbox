"""CLI bridge for solving a COBRA-style QPproblem via the OptArrow contract."""
...
def main() -> None:
    ...
    qp_problem = payload["qp_problem"]
    solver_params = payload.get("solver_params", {})

    _, raw_result, cobra_solution = solve_cobra_qp_via_optarrow(
        qp_problem,
