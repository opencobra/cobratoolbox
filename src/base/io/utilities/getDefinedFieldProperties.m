...
optionalFields = ...
    ...
    'comp','comp',1,'iscell(x) && all(cellfun(@(y) ischar(y) , x))';...
    'proteinNames','proteins',1,'iscell(x) && all(cellfun(@(y) ischar(y) , x))';...    
    'proteins',NaN,1,'iscell(x) && all(cellfun(@(y) ischar(y) , x))';...
    'geneNames','gene',1,'iscell(x) && all(cellfun(@(y) ischar(y) , x))'};
