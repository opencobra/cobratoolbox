...
%
% INPUTS:
%    model:           COBRA metabolic network model, with fields:
%
%                       * .rxns - reaction identifiers
%                       * .mets - metabolite identifiers
%                       * .S - `met` x `rxn` stoichiometric matrix
%                       * .lb - lower flux bounds, used to determine
%                         reaction directionality
%                       * .genes - (optional) gene identifiers
%                       * .rxnGeneMat - (optional) `rxn` x `gene`
%                         reaction-gene incidence matrix, required if `.genes` is present
%                       * .subSystems - (optional) subsystem assignment(s) per reaction
