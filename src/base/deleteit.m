function [gdlsSolution, bilevelMILPProblem, gdlsSolutionStructs] = deleteit(model, targetRxns, varargin)
...
% USAGE:
%
%    [gdlsSolution, bilevelMILPProblem, gdlsSolutionStructs] = deleteit(model, varargin)
%
% INPUTS:
