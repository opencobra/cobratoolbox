function [bondsBrokenAndFormed, substrateMass] = findBondsBrokenAndFormed(model, rxnDir, printLevel)
...
if nargin < 3 || isempty(printLevel)
    printLevel = 0;
end
...
bondsBrokenAndFormed = zeros(size(model.rxns));
