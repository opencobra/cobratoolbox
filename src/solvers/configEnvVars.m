function configEnvVars(printLevel)
    ...
    if ENV_VARS.STATUS == 0
        ...
        solverPaths{2,2} = {'/opt/gurobi/gurobi700', '/Library/gurobi600', '/Library/gurobi650', '/Library/gurobi702', '/opt/gurobi650', '/opt/gurobi70', 'C:\gurobi600', 'C:\gurobi650', 'C:\gurobi70'};
