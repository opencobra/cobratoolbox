function [debuggingFolder,debuggingReport, fixedModels, failedModels]=runDebuggingTools(refinedFolder,testResultsFolder,infoFilePath,inputDataFolder,reconVersion,varargin)
...
%
% USAGE
%       [debuggingFolder,debuggingReport, fixedModels, failedModels]=runDebuggingTools(refinedFolder,testResultsFolder,infoFilePath,inputDataFolder,numWorkers,reconVersion,varargin)
%
% INPUTS
...
if length(failedModels)>0
    ...
    for i=1:steps:length(failedModels)
        ...
        parfor j=i:i+endPnt
            ...
            [revisedModel,gapfilledReactions,replacedReactions]=debugModel(model,Results,infoFilePath,inputDataFolder,failedModels{j,1},biomassReaction);
