...
growthRequirements = readtable([inputDataFolder filesep 'GrowthRequirementsTable.txt'], 'Delimiter', 'tab','TreatAsEmpty',['UND. -60001','UND. -2011','UND. -62011']);
growthRequirements = [growthRequirements.Properties.VariableDescriptions;table2cell(growthRequirements)];
