...
%
%                                 * testResultsFolder - Folder where the test
%                                   results are saved (default: current
%                                   folder, subfolder `TestResults`)
%                                 * numWorkers - Number of workers in parallel
%                                   pool (default: 2)
%                                 * createReports - Boolean defining if a
%                                   report for each reconstruction should be
%                                   created (default: false)
%                                 * reportsFolder - Folder where reports
%                                   should be saved (default: '')
%                                 * translatedDraftsFolder - Folder with
%                                   translated draft COBRA models generated by
%                                   the KBase pipeline to analyze (will only
%                                   be analyzed if the folder is provided,
%                                   default: '')
%
% OUTPUTS:
