...
% immediately after `addToTmodel`. Called by `addToTmodel`, `mergeBorgModels`, `mergeTrxns`, calls `TmodelFields`, `buildRxnEquations`, `removeDuplicateNames`, `makeNamesUnique`, `charpos`, `removeProblematicCharacters`.
%
% USAGE:
%
