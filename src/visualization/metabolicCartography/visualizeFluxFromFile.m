...
% This function takes a CellDesigner map XML file and a flux vector table file
% (e.g., CSV or XLSX), visualizes the flux on the map, and saves the output map
% as a CellDesigner XML file
%
% USAGE:
%
...
%
% OPTIONAL INPUTS:
%    outputXMLFile:     The output `.xml` file name for the updated map
%                       (default `'VisualizedFluxOnMap.xml'`)
%
% NOTE:
%    The map with visualized flux is saved as the specified CellDesigner XML file;
