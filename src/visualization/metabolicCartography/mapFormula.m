...
%                      * .rxnBaseReactantID - Cell array, per reaction, of
%                        base reactant species IDs
%                      * .rxnReactantID - Cell array, per reaction, of
%                        secondary reactant species IDs
%                      * .rxnBaseProductID - Cell array, per reaction, of
%                        base product species IDs
%                      * .rxnProductID - Cell array, per reaction, of
%                        secondary product species IDs
%                      * .rxnReversibility - Cell array of `'true'`/`'false'`
%                        reversibility strings, per reaction
