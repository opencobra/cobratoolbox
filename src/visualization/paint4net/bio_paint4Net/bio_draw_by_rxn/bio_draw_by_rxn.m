...
% reactions.
%
% function [involvedMets,deadEnds,deadRxns]=bio_draw_by_rxn(model,rxns,drawMap,direction,initialMet,excludeMets,flux,save,closev)
%
% INPUT
%
...
%       because the command draw_by_met is calling out the command bio_draw_by_rxn
...
%       the command draw_by_met is calling out the command bio_draw_by_rxn and 
