function [involvedMets, deadEnds, deadRxns] = bio_draw_by_rxn(model, rxns, drawMap, direction, initialMet, excludeMets, flux, save, closev, reportDeadEnds)
% Defines the visualisation scope from a list of reactions.
%
% USAGE:
%
%    [involvedMets, deadEnds, deadRxns] = bio_draw_by_rxn(model, rxns, drawMap, direction, initialMet, excludeMets, flux, save, closev, reportDeadEnds)
%
% INPUTS:
...
%                      as a green ellipse on the map. This option supports
%                      `draw_by_met`, which calls `bio_draw_by_rxn` and passes
%                      `initialMet`.
%
%                      Default: empty
%
...
%
% NOTE:
%    This function is part of Paint4Net. It supports `draw_by_met`, which calls
%    `bio_draw_by_rxn` and passes the `direction` and `initialMet` arguments.
%
% .. Author:
