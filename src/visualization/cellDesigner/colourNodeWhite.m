...
% Highlights the metabolite nodes using the same colour scheme as in
...
%                          produced by `parseCD` (used here via its `.ID`
%                          sub-field)
...
%
% OPTIONAL OUTPUTS:
%    parsed_update:    An updated parsed model structure.
