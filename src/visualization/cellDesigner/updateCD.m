...
%    parsed:          A parsed CD model structure generated by `parseCD`
%                     function, with fields:
%
%                       * .r_info - the per-property parsed representation
%                         produced by `parseCD` (used here via its
%                         `.species` sub-field)
%
% OPTIONAL INPUT:
...
%                       * .number - The line number(s) in `text` where a
%                         species/name replacement was found.
%                       * .changedStrLines - The changed line of text for
%                         each replacement made.
%                       * .col - Record of the column number of the species
%                         that is replaced with a new species name (only
%                         populated when `note` is `'true'`).
%
% EXAMPLE:
%
