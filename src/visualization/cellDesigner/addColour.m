...
%
% OPTIONAL INPUT:
%    colorScheme:     Index (1-5) of the built-in colour palette used to
%                     generate the highlight colours (default: 2)
%
% OUTPUT:
%
%    ref:             An updated parsed `CellDesigner` model structure
%    listRxnColour:    A list of `{reactionID, colourCode}` pairs that were
%                     newly assigned a highlight colour
%
