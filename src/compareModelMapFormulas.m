    function [Wrong_table,Absent_model_table,Absent_map_table,Duplicate_table] = Compare_model_map_formulas(model, map, excel_name)
    ...
    % USAGE:
    %
    %   Wrong_table,Absent_model_table,Absent_map_table,Duplicate_table = Compare_model_map_formulas(model, map, excel_name)
    %
    % INPUTS:
    %
    ...
    %                   
    % .. Author:
    % N.Sompairac.  LCSB, Belval, Luxembourg, 25/07/2017 
