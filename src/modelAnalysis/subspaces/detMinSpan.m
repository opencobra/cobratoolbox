...
% detMinSpan
% This algorithm calculates the MinSpan vectors for a COBRA model. The
...
% 
%   params.coverage     Number of iterations to run the algorithm, if not
%                       converge (Default = 10)
%   params.timeLimit    Time to spend on each MinSpan calculation (sec),
%                       (Default = 30)
%   params.saveIntV     Save intermediate vectors in order to restart from
%                       latest iteration (Default = 1)
%   params.cores        Number of cores to use (Default = 1)
% 
