...
%        diffRxns                           all differential reactions that distingish unionModel and intersect model
%        diffExRxns                         all differential exchange reactions that distingish unionModel and intersect model
%
%
%% Maike Aurich 02/07/2015
