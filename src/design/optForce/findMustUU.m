function [mustUU, posMustUU, mustUU_linear, pos_mustUU_linear] = findMustUU(model, ...
...
% USAGE: 
%
%    [mustUU, posMustUU, mustUU_linear, pos_mustUU_linear] = findMustUU(model, ...
%    minFluxesW, maxFluxesW, constrOpt, excludedRxns, runID, outputFolder,...
%    outputFileName, printExcel, printText, printReport, keepInputs, verbose)       
%
% INPUTS:
