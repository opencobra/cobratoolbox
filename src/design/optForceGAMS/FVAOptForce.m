...
%% DESCRIPTION
% Calculates flux ranges for each reaction in the wild-type strain and in
% the mutant strain. Constraints should be specified for at least one
% strain (wild-type or mutant)
%
% Usage1: FVAOptForce(model, constrWT)
%         specify constraints only for wild-type strain
%
% Usage2: FVAOptForce(model, {}, constrMT)
%         specify constraints only for mutant strain
%
