...
% 
%         excludedURxns(optional):  Type: cell array
%                                   Description: Reactions to be excluded from
%                                   upregulations. This could be used to avoid
%                                   finding transporters or exchange reactions in
%                                   the set
% 
%         excludedLRxns(optional):  Type: cell array
%                                   Description: Reactions to be excluded from
%                                   downregulations. This could be used to avoid
%                                   finding transporters or exchange reactions in
%                                   the set
% 
%         excludedKRxns(optional):  Type: cell array
%                                   Description: Reactions to be excluded from
%                                   knockouts This could be used to avoid
%                                   finding transporters or exchange reactions in
%                                   the set
%
% OUTPUTS FILES:
...
%                                       Description: File containing the target
%                                       reaction
% 
%         mustU.mat                     Type: file
...
%
%         k.mat                         Type: file
%                                       Description: File containing "k"
%                                       the number of reactions in the
%                                       optForce set
%
%         nSets.mat                     Type: file
%                                       Description: File containing the
%                                       maximum number of sets found by
%                                       optForce
