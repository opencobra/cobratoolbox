...
% perspective of each organism. The outcomes are as follows:
...
% OPTIONAL INPUT
% sigD the difference between co-growth and single growth that is
% considered significant (10% =0.1 by default)
