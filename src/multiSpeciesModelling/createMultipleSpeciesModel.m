...
% Do this for all models to be added
...
for i = 1 : length(modelNew.mets)
    if ~isempty(strfind(modelNew.mets{i},strcat('[',exTag,']')))
        ...
        [modelNew,rxnIDexists] = addReaction...
            (modelNew,strcat(nameTag,'IEX_',MexG{cnt},'tr'),{Mex MexG{cnt}},[-1 1],1,...
