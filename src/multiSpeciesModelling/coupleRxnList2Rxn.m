...
if exist('c', 'var')
    c = c*ones(length(rxnList),1); %moved by fede...commented in the original position
end
...
if exist('u', 'var')
    u = u*ones(length(rxnList),1); % moved by fede...commented in the original position
end
