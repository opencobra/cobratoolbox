...
% internal and every external reaction admits a non-zero steady state flux. In 
% this example, we take Recon3.0model, set the lower bound on the biomass reaction 
