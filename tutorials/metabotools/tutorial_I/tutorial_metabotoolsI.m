...
% 
% In this tutorial we generate contextualized models of two lymphoblastic leukemia cell lines, CCRF-CEM and Molt- 4 cells, 
% will be generated by integrating semi-quantitative metabolomic data, transcriptomic data, and growth rates. 
% We will afterwards analyze the solution space of these models by sampling analysis.
%
% Before running a section in the tutorial, read the corresponding sections in the MetaboTools protocol and supplemental tutorial 
% (Data sheet 2, http://journal.frontiersin.org/article/10.3389/fphys.2016.00327/full). 
%%
