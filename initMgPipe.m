...
% Here we will match the inputs: if a driver exists this section will no tmake any difference 
% else it will prepare inputs and output inputs variables

modPath=modPath;
toolboxPath=toolboxPath;
resPath=resPath;
dietFilePath=dietFilePath;
