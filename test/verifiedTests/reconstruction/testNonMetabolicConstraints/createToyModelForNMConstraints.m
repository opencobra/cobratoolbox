function model = createToyModelForNMConstraints()
...
model = addNMConstraint(model,{'R3','R7'},'c',[1,1],'d',5,'dsense','G','ConstraintID','R3_and_R7_above_5');
model = addNMConstraint(model,{'R4','R6'},'c',[1,1],'d',30,'dsense','L','ConstraintID','R4_and_R6_lowerthan_30');