...
solvers = COBRARequisitesFullfilled('needsLP',true,'needsMILP',true,'toolboxes',requiredToolboxes);
...
tested = true;
fprintf('Testing optGene using %s as LP and %s as MILP solver...\n', solvers.LP, solvers.MILP);
% function outputs
