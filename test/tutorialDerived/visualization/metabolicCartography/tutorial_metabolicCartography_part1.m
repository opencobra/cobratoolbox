...
% 
% In this tutorial, manipulation of CellDesgner maps in COBRA toolbox and visualising 
% model predictions is explained. The main covered topics are:
%% 
...
%% 
% The present tutorial can run with glpk package, which does not require additional 
% installation and configuration. Although, for the analysis of large models it 
% is recommended to use the GUROBI package.
...
% Metabolic Human database (VMH, <https://vmh.life%29. https://vmh.life).> 
% 
...
% 
% In order to check the reaction reversibility, reaction formulae can be printed 
% from the map and model using different functions.
...
%% 
% _*NOTE!* Formula errors can only be manually corrected from the XML file in 
% Cell designer._
...
% 
% 
% Furthermore, we can also color reactions linked to specific metabolites by 
% combining functions for the COBRA models and Visualisation. The function |findRxnsFromMets| 
% identify all reactions containing specific metabolites. Here we want to find 
% reactions containing "mitochondrial ATP and ADP", and colour these reactions 
% in "aquamarine".  Moreover,the newly generated map will be transformed into 
% a XML file.
...
% 
% 
% _*NOTE!* This funtion colors a list of specific metabolites whereas the function 
% |addColourNode| color all nodes linked to a specific list of reactions._
% 
...
% *REFERENCES:* 
%% 
% # Hyduke D. COBRA Toolbox 2.0. _Nature Protocols_ (2011). 
