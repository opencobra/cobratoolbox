function [modelOut,removeMetBool,removeRxnBool] = manuallyAdaptRecon3Ines(model,printLevel)
...
if 1
    ...
    removeRxnAbbr={...
        'HMR_0792',...%Galactosylceramide Sulfotransferase	Glycosphingolipid metabolism
             'RE3039C',...%	                                           RE3039C	Glycerophospholipid metabolism
             'RE3045C',...%	                     Alkylacetylglycerophosphatase	Glycerophospholipid metabolism
        'RTOT_2',...	%R2coa_hs[c] + R4coa_hs[c] 	->	2 Rtotal2coa[c] %NEEDED FOR CAPR
        'ARTFR205',...	%h[m] + nadph[m] + 2 fadh2[m] + dlnlcgcoa[c] 	->	nadp[m] + 2 fad[m] + 1.25 R2coa_hs[c] %NEEDED FOR CAPR
        ...
        'NM_8',...	%CE4888[c] 	->	neuromelanin[c]
           'HMR_0866',...%          Galactoside 2-Alpha-L-Fucosyltransferase	Glycosphingolipid metabolism
           'HMR_0892',...% 	                                          HMR_0892	Glycosphingolipid metabolism
        ''};
    
%         '3HPVSTETCOAhcm',... % Unbalanced rxns drug module
%         '3HPVSTETCOAhcx',...% Unbalanced rxns drug module
%         'PROFVSCOAhc',...% Unbalanced rxns drug module
%         '3HPVSCOAhc',...% Unbalanced rxns drug module
%         'NAPQIhr',...% Unbalanced rxns drug module
    ...
    %   'r0771	Tetradecanoyl-[Acyl-Carrier Protein]:Malonyl Coenzyme A C-Acyltransferase (Decarboxylating, Oxoacyl- And Enoyl-Reducing And Thioester-Hydrolysing) Fatty Acid Biosynthesis	Fatty acid synthesis
    %          'RE2977C'	                     Alcohol Dehydrogenase (NADP+)	Glycerophospholipid metabolism
    %        'HMR_0588'	      1-Acylglycerol-3-Phosphate O-Acyltransferase	Glycerophospholipid metabolism
    %       'HMR_6813'	                                        Peroxidase	Phenylalanine metabolism
