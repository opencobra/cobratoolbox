    ...
    <div class="wrapper">
        <ul class="metro">
            <li class="small-tile-text color_class5 scale-10">
                <a class="tile" style="width: 90px; height: 90px;" href="cobratoolbox/stable/tutorials/analysis/FBA/practical_FBA.pdf">
...
.. raw:: html
    ...
    <div style="margin:-30px; margin-right:-30px;">
      <iframe src="cobratoolbox/stable/tutorials/analysis/FBA/iframe_practical_FBA.html" width="100%" scrolling="yes" id="iFrameResizer0" style="overflow: visible; height: 228px;" frameborder="0"></iframe>
    </div>
