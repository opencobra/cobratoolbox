...
.. raw:: html
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-sm-6 text-center">
            ...
            <div class="col-lg-4 col-sm-6 text-center">
            <p>Catherine M. Clancy</p>
        </div>
            <div class="col-lg-4 col-sm-6 text-center">
            <p>Jennifer Modamio</p>
        </div>
            <div class="col-lg-4 col-sm-6 text-center">
            <p>John T. Sauls</p>
        </div>
            ...
            <div class="col-lg-4 col-sm-6 text-center">
            <p>Francisco J. Aragon Artacho</p>
        </div>
            <div class="col-lg-4 col-sm-6 text-center">
            <p>Francisco J. Planes</p>
        </div>
            <div class="col-lg-4 col-sm-6 text-center">
            <p>Egils Stalidzans</p>
        </div>
            <div class="col-lg-4 col-sm-6 text-center">
            <p>Alejandro Maass</p>
        </div>
            ...
            <div class="col-lg-4 col-sm-6 text-center">
            <p>Michael A. Saunders</p>
        </div>
            <div class="col-lg-4 col-sm-6 text-center">
            <p>Costas D. Maranas</p>
        </div>
            <div class="col-lg-4 col-sm-6 text-center">
            <p>Nathan E. Lewis</p>
        </div>
            ...
            <div class="col-lg-4 col-sm-6 text-center">
            <p>Bernhard O. Palsson</p>
        </div>
            <div class="col-lg-4 col-sm-6 text-center">
            <p>Ines Thiele</p>
        </div>
            <div class="col-lg-4 col-sm-6 text-center">
            <p>Ronan M.T. Fleming</p>
        </div>
    </div>
