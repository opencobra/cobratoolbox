...
for m=2:nMet+1
    model.metabolites{m,1}=model.met(m-1).abbreviation;
    model.metabolites{m,2}=model.met(m-1).officialName;
    model.metabolites{m,3}=model.met(m-1).dGft0Min;
    model.metabolites{m,4}=model.met(m-1).dGft0Max;
    model.metabolites{m,5}=model.met(m-1).dGftMin;
    model.metabolites{m,6}=model.met(m-1).dGftMax;
