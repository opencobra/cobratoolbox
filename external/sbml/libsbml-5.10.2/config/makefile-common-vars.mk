...
top_srcdir        = /home/rfleming/work/sbg-code/cobratoolbox/external/sbml/libsbml-5.10.2
top_builddir      = /home/rfleming/work/sbg-code/cobratoolbox/external/sbml/libsbml-5.10.2
...
RUN_LDPATH        = :/usr/local/bin/tomlab/shared:/usr/local/bin/mosek/7/tools/platform/linux64x86/bin:/usr/local/bin/gurobi562/linux64/lib:/usr/local/bin/adobe/Adobe/Reader9/Reader/intellinux/lib:/usr/local/bin/babel
...
USE_MATLAB        = 1
MATLAB            = /usr/local/bin/MATLAB/R2013b/bin/matlab
...
PACKAGE_STRING    = libSBML 5.10.2
PACKAGE_TARNAME   = libsbml
PACKAGE_VERSION   = 5.10.2
RANLIB            = ranlib
SHAREDLIBEXT      = so
LIBTOOL           = $(top_builddir)/doltlibtool
SHELL             = /bin/bash

LIBSBML_VERSION   = 5.10.2
LIBSBML_VERSION_NUMERIC = 51002
