                  ...
                  int nrhs, const mxArray *prhs[] )
{
  ...
  /* magnitude */
  mpfr_exp(temp,xr,GMP_RNDN);

  /* real part */
  mpfr_cos(zr,xi,GMP_RNDN);
  mpfr_mul(zr,zr,temp,GMP_RNDN);
  
  /* imag part */
  mpfr_sin(zi,xi,GMP_RNDN);
  mpfr_mul(zi,zi,temp,GMP_RNDN);
