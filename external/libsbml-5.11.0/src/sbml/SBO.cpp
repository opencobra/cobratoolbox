...
SBO::populateSBOTree()
{
  ...
  mParent.insert( pair<const int, int>(605, 244) );
  mParent.insert( pair<const int, int>(606, 244) );
  mParent.insert( pair<const int, int>(607, 296) );
  mParent.insert( pair<const int, int>(608, 607) );
