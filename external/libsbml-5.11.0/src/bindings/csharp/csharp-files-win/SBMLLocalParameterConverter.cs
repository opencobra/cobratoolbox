  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          libsbmlPINVOKE.delete_SBMLLocalParameterConverter(swigCPtr);
        }
...
/**
   ...
   */ public
 SBMLLocalParameterConverter(SBMLLocalParameterConverter obj) : this(libsbmlPINVOKE.new_SBMLLocalParameterConverter__SWIG_1(SBMLLocalParameterConverter.getCPtr(obj)), true) {
...
/**
   ...
   */ public new
 SBMLConverter clone() {
    IntPtr cPtr = libsbmlPINVOKE.SBMLLocalParameterConverter_clone(swigCPtr);
    SBMLLocalParameterConverter ret = (cPtr == IntPtr.Zero) ? null : new SBMLLocalParameterConverter(cPtr, true);
    return ret;
  }
