    ...
    <div class="wrapper">
        <ul class="metro">
            <li class="small-tile-text color_class5 scale-10">
                <a class="tile" style="width: 90px; height: 90px;" href="https://gibbs.unal.edu.co/cobradoc/cobratoolbox/tutorials/analysis/FBA/practical_FBA.pdf">
            ...
            <li class="small-tile-text color_class6 scale-10">
                <a class="tile" style="width: 90px; height: 90px;" href="https://github.com/opencobra/COBRA.tutorials/raw/master/analysis/FBA/practical_FBA.mlx">
            ...
            <li class="small-tile-text color_class7 scale-10">
                <a class="tile" style="width: 90px; height: 90px;" href="https://github.com/opencobra/COBRA.tutorials/raw/master/analysis/FBA/practical_FBA.m">
            ...
            <li class="small-tile-text color_class8 scale-10">
                <a class="tile" style="width: 90px; height: 90px;" href="https://github.com/opencobra/COBRA.tutorials/tree/master/analysis/FBA">
...
.. raw:: html
    ...
    <div style="margin:-30px; margin-right:-30px;">
      <iframe src="https://gibbs.unal.edu.co/cobradoc/cobratoolbox/tutorials/analysis/FBA/iframe_practical_FBA.html" width="100%" scrolling="yes" id="iFrameResizer0" style="overflow: visible; height: 228px;" frameborder="0"></iframe>
    </div>
