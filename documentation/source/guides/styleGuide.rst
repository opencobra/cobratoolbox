...
.. |computer| raw:: html
   ...
   <img src="/cobratoolbox/stable/_static/img/computer.png" height="20px" width="20px" alt="computer">


.. |bug| raw:: html

   <img src="/cobratoolbox/stable/_static/img/bug.png" height="20px" width="20px" alt="bug">


.. |apple| raw:: html

   <img src="/cobratoolbox/stable/_static/img/apple.png" height="20px" width="20px" alt="apple">


.. |art| raw:: html

   <img src="/cobratoolbox/stable/_static/img/art.png" height="20px" width="20px" alt="art">


.. |fire| raw:: html

   <img src="/cobratoolbox/stable/_static/img/fire.png" height="20px" width="20px" alt="fire">


.. |green_heart| raw:: html

   <img src="/cobratoolbox/stable/_static/img/green_heart.png" height="20px" width="20px" alt="green_heart">


.. |memo| raw:: html

   <img src="/cobratoolbox/stable/_static/img/memo.png" height="20px" width="20px" alt="memo">


.. |penguin| raw:: html

   <img src="/cobratoolbox/stable/_static/img/penguin.png" height="20px" width="20px" alt="penguin">


.. |racehorse| raw:: html

   <img src="/cobratoolbox/stable/_static/img/racehorse.png" height="20px" width="20px" alt="racehorse">


.. |white_check_mark| raw:: html

   <img src="/cobratoolbox/stable/_static/img/white_check_mark.png" height="20px" width="20px" alt="white_check_mark">
