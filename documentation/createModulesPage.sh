...
do
    ...
    echo "     <div class=\"sectionLogo\"><img class=\"avatar\" src=\"https://github.com/opencobra/cobratoolbox/tree/gh-pages/stable/_static/img/${section}.png\"></div>" >> $rstFunctionPath
